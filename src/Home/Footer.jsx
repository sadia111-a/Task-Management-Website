const Footer = () => {
  return (
    <footer>
      <div className="footer p-10 p-10 bg-neutral border-2 text-neutral-content">
      ...
      <div className=" footer-center p-4 bg-blue-200 text-base-content">
        <aside>
          <p>
            Copyright © 2023 - All right reserved by <b>TaskFlow</b> Academy
          </p>
        </aside>
      </div>
    </footer>
